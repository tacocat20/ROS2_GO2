...
{
  new (message_memory) go2_interfaces::msg::HeightMap(_init);
}

void HeightMap_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::HeightMap *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HeightMap_message_member_array[7] = {
  {
    ...
    offsetof(go2_interfaces::msg::HeightMap, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::HeightMap, frame_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::HeightMap, resolution),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::HeightMap, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::HeightMap, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::HeightMap, origin),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::HeightMap, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HeightMap_message_members = {
  ...
  7,  // number of fields
  sizeof(go2_interfaces::msg::HeightMap),
...
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::HeightMap_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, HeightMap)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::HeightMap_message_type_support_handle;
}
