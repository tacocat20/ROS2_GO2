...
{
  new (message_memory) go2_interfaces::msg::InterfaceConfig(_init);
}

void InterfaceConfig_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::InterfaceConfig *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InterfaceConfig_message_member_array[3] = {
  {
    ...
    offsetof(go2_interfaces::msg::InterfaceConfig, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::InterfaceConfig, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::InterfaceConfig, reserve),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers InterfaceConfig_message_members = {
  ...
  3,  // number of fields
  sizeof(go2_interfaces::msg::InterfaceConfig),
...
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::InterfaceConfig_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, InterfaceConfig)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::InterfaceConfig_message_type_support_handle;
}
