...
{
  new (message_memory) go2_interfaces::msg::MotorCmds(_init);
}

void MotorCmds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::MotorCmds *>(message_memory);
  typed_message->~MotorCmds();
}

size_t size_function__MotorCmds__cmds(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<go2_interfaces::msg::MotorCmd> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<go2_interfaces::msg::MotorCmd> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<go2_interfaces::msg::MotorCmd> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCmds_message_member_array[1] = {
  {
    ...
    offsetof(go2_interfaces::msg::MotorCmds, cmds),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorCmds_message_members = {
  ...
  1,  // number of fields
  sizeof(go2_interfaces::msg::MotorCmds),
...
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorCmds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, MotorCmds)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorCmds_message_type_support_handle;
}
