...
{
  new (message_memory) go2_interfaces::msg::LowCmd(_init);
}

void LowCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::LowCmd *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<go2_interfaces::msg::MotorCmd, 20> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<go2_interfaces::msg::MotorCmd, 20> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__LowCmd__motor_cmd(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const go2_interfaces::msg::MotorCmd *>(
    get_const_function__LowCmd__motor_cmd(untyped_member, index));
  auto & value = *reinterpret_cast<go2_interfaces::msg::MotorCmd *>(untyped_value);
  value = item;
}
...
void assign_function__LowCmd__motor_cmd(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<go2_interfaces::msg::MotorCmd *>(
    get_function__LowCmd__motor_cmd(untyped_member, index));
  const auto & value = *reinterpret_cast<const go2_interfaces::msg::MotorCmd *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LowCmd_message_member_array[14] = {
  {
    ...
    offsetof(go2_interfaces::msg::LowCmd, head),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, level_flag),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, frame_reserve),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, sn),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, version),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, bandwidth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<go2_interfaces::msg::MotorCmd>(),  // members of sub message
    true,  // is array
    20,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, motor_cmd),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<go2_interfaces::msg::BmsCmd>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, bms_cmd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    40,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, wireless_remote),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    12,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, led),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, fan),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, gpio),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, reserve),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::LowCmd, crc),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LowCmd_message_members = {
  ...
  "LowCmd",  // message name
  14,  // number of fields
  sizeof(go2_interfaces::msg::LowCmd),
...
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::LowCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, LowCmd)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::LowCmd_message_type_support_handle;
}
