...
{
  new (message_memory) go2_interfaces::msg::Error(_init);
}

void Error_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::Error *>(message_memory);
  typed_message->~Error();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Error_message_member_array[2] = {
  {
    ...
    offsetof(go2_interfaces::msg::Error, source),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::Error, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Error_message_members = {
  ...
  "Error",  // message name
  2,  // number of fields
  sizeof(go2_interfaces::msg::Error),
...
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::Error_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, Error)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::Error_message_type_support_handle;
}
