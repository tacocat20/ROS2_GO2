...
{
  new (message_memory) go2_interfaces::msg::TimeSpec(_init);
}

void TimeSpec_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::TimeSpec *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TimeSpec_message_member_array[2] = {
  {
    ...
    offsetof(go2_interfaces::msg::TimeSpec, sec),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::TimeSpec, nanosec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TimeSpec_message_members = {
  ...
  2,  // number of fields
  sizeof(go2_interfaces::msg::TimeSpec),
...
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::TimeSpec_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, TimeSpec)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::TimeSpec_message_type_support_handle;
}
