...
{
  new (message_memory) go2_interfaces::msg::SportModeCmd(_init);
}

void SportModeCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::SportModeCmd *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<go2_interfaces::msg::PathPoint, 30> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<go2_interfaces::msg::PathPoint, 30> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__SportModeCmd__path_point(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const go2_interfaces::msg::PathPoint *>(
    get_const_function__SportModeCmd__path_point(untyped_member, index));
  auto & value = *reinterpret_cast<go2_interfaces::msg::PathPoint *>(untyped_value);
  value = item;
}
...
void assign_function__SportModeCmd__path_point(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<go2_interfaces::msg::PathPoint *>(
    get_function__SportModeCmd__path_point(untyped_member, index));
  const auto & value = *reinterpret_cast<const go2_interfaces::msg::PathPoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SportModeCmd_message_member_array[11] = {
  {
    ...
    offsetof(go2_interfaces::msg::SportModeCmd, mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, gait_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, speed_level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, foot_raise_height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, body_height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, position),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, euler),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, velocity),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, yaw_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, bms_cmd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<go2_interfaces::msg::PathPoint>(),  // members of sub message
    true,  // is array
    30,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::SportModeCmd, path_point),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SportModeCmd_message_members = {
  ...
  11,  // number of fields
  sizeof(go2_interfaces::msg::SportModeCmd),
...
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::SportModeCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, SportModeCmd)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::SportModeCmd_message_type_support_handle;
}
