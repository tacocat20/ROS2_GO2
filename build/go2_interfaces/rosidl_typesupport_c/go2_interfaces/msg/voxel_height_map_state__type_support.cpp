...
static const _VoxelHeightMapState_type_support_symbol_names_t _VoxelHeightMapState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, VoxelHeightMapState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, go2_interfaces, msg, VoxelHeightMapState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, go2_interfaces, msg, VoxelHeightMapState)() {
  return &::go2_interfaces::msg::rosidl_typesupport_c::VoxelHeightMapState_message_type_support_handle;
}
