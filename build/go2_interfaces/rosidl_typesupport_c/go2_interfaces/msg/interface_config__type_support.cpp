...
static const _InterfaceConfig_type_support_symbol_names_t _InterfaceConfig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, InterfaceConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, go2_interfaces, msg, InterfaceConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, go2_interfaces, msg, InterfaceConfig)() {
  return &::go2_interfaces::msg::rosidl_typesupport_c::InterfaceConfig_message_type_support_handle;
}
