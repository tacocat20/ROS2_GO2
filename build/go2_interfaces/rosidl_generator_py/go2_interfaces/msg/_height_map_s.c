...
bool go2_interfaces__msg__height_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._height_map.HeightMap", full_classname_dest, 40) == 0);
  }
  go2_interfaces__msg__HeightMap * ros_message = _ros_message;
  {  // stamp
...
PyObject * go2_interfaces__msg__height_map__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._height_map");
