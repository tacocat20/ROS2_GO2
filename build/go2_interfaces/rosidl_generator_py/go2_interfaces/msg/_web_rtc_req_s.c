...
bool go2_interfaces__msg__web_rtc_req__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._web_rtc_req.WebRtcReq", full_classname_dest, 41) == 0);
  }
  go2_interfaces__msg__WebRtcReq * ros_message = _ros_message;
  {  // id
...
PyObject * go2_interfaces__msg__web_rtc_req__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._web_rtc_req");
