...
bool go2_interfaces__msg__bms_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * go2_interfaces__msg__bms_cmd__convert_to_py(void * raw_ros_message);
bool go2_interfaces__msg__path_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * go2_interfaces__msg__path_point__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool go2_interfaces__msg__sport_mode_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._sport_mode_cmd.SportModeCmd", full_classname_dest, 47) == 0);
  }
  go2_interfaces__msg__SportModeCmd * ros_message = _ros_message;
  {  // mode
  ...
  {  // bms_cmd
    ...
    if (!go2_interfaces__msg__bms_cmd__convert_from_py(field, &ros_message->bms_cmd)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // path_point
    ...
    Py_ssize_t size = 30;
    go2_interfaces__msg__PathPoint * dest = ros_message->path_point;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!go2_interfaces__msg__path_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * go2_interfaces__msg__sport_mode_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._sport_mode_cmd");
  ...
  {  // bms_cmd
    PyObject * field = NULL;
    field = go2_interfaces__msg__bms_cmd__convert_to_py(&ros_message->bms_cmd);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // path_point
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = go2_interfaces__msg__path_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
