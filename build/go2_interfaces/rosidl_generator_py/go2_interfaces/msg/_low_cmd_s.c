...
bool go2_interfaces__msg__motor_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool go2_interfaces__msg__low_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._low_cmd.LowCmd", full_classname_dest, 34) == 0);
  }
  go2_interfaces__msg__LowCmd * ros_message = _ros_message;
  {  // head
  ...
  {  // motor_cmd
    ...
    Py_ssize_t size = 20;
    go2_interfaces__msg__MotorCmd * dest = ros_message->motor_cmd;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!go2_interfaces__msg__motor_cmd__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * go2_interfaces__msg__low_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._low_cmd");
  ...
  {  // motor_cmd
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = go2_interfaces__msg__motor_cmd__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
