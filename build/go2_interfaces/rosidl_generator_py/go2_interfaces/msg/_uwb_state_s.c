...
bool go2_interfaces__msg__uwb_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._uwb_state.UwbState", full_classname_dest, 38) == 0);
  }
  go2_interfaces__msg__UwbState * ros_message = _ros_message;
  {  // version
...
PyObject * go2_interfaces__msg__uwb_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._uwb_state");
