...
bool go2_interfaces__msg__time_spec__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool go2_interfaces__msg__sport_mode_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._sport_mode_state.SportModeState", full_classname_dest, 51) == 0);
  }
  go2_interfaces__msg__SportModeState * ros_message = _ros_message;
  {  // stamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "stamp");
    if (!field) {
      return false;
    }
    if (!go2_interfaces__msg__time_spec__convert_from_py(field, &ros_message->stamp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * go2_interfaces__msg__sport_mode_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._sport_mode_state");
  ...
  {  // stamp
    PyObject * field = NULL;
    field = go2_interfaces__msg__time_spec__convert_to_py(&ros_message->stamp);
    if (!field) {
      return NULL;
    }
    {
