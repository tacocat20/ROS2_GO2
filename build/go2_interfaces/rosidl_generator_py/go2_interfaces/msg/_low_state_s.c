...
bool go2_interfaces__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * go2_interfaces__msg__motor_state__convert_to_py(void * raw_ros_message);
bool go2_interfaces__msg__bms_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * go2_interfaces__msg__bms_state__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool go2_interfaces__msg__low_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._low_state.LowState", full_classname_dest, 38) == 0);
  }
  go2_interfaces__msg__LowState * ros_message = _ros_message;
  {  // head
  ...
  {  // imu_state
    ...
    if (!go2_interfaces__msg__imu__convert_from_py(field, &ros_message->imu_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // motor_state
    ...
    Py_ssize_t size = 20;
    go2_interfaces__msg__MotorState * dest = ros_message->motor_state;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!go2_interfaces__msg__motor_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // bms_state
    ...
    if (!go2_interfaces__msg__bms_state__convert_from_py(field, &ros_message->bms_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * go2_interfaces__msg__low_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._low_state");
  ...
  {  // imu_state
    PyObject * field = NULL;
    field = go2_interfaces__msg__imu__convert_to_py(&ros_message->imu_state);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // motor_state
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = go2_interfaces__msg__motor_state__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // bms_state
    PyObject * field = NULL;
    field = go2_interfaces__msg__bms_state__convert_to_py(&ros_message->bms_state);
    if (!field) {
      return NULL;
    }
    {
