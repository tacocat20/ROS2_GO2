...
bool go2_interfaces__msg__go2_front_video_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._go2_front_video_data.Go2FrontVideoData", full_classname_dest, 58) == 0);
  }
  go2_interfaces__msg__Go2FrontVideoData * ros_message = _ros_message;
  {  // time_frame
...
PyObject * go2_interfaces__msg__go2_front_video_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._go2_front_video_data");
