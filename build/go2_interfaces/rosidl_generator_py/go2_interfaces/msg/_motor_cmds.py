...
class MotorCmds(metaclass=Metaclass_MotorCmds):
    ...
    _fields_and_field_types = {
        'cmds': 'sequence<go2_interfaces/MotorCmd>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['go2_interfaces', 'msg'], 'MotorCmd')),  # noqa: E501
    )
