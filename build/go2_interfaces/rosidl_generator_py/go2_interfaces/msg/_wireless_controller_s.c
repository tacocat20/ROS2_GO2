...
bool go2_interfaces__msg__wireless_controller__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._wireless_controller.WirelessController", full_classname_dest, 58) == 0);
  }
  go2_interfaces__msg__WirelessController * ros_message = _ros_message;
  {  // lx
...
PyObject * go2_interfaces__msg__wireless_controller__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._wireless_controller");
