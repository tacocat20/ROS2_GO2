...
bool go2_interfaces__msg__bms_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("go2_interfaces.msg._bms_cmd.BmsCmd", full_classname_dest, 34) == 0);
  }
  go2_interfaces__msg__BmsCmd * ros_message = _ros_message;
  {  // off
...
PyObject * go2_interfaces__msg__bms_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("go2_interfaces.msg._bms_cmd");
