...
go2_interfaces__msg__HeightMap__init(go2_interfaces__msg__HeightMap * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->frame_id)) {
    go2_interfaces__msg__HeightMap__fini(msg);
    return false;
  }
  // resolution
  // width
...
go2_interfaces__msg__HeightMap__create()
{
  ...
  go2_interfaces__msg__HeightMap * msg = (go2_interfaces__msg__HeightMap *)allocator.allocate(sizeof(go2_interfaces__msg__HeightMap), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(go2_interfaces__msg__HeightMap));
  bool success = go2_interfaces__msg__HeightMap__init(msg);
  if (!success) {
...
go2_interfaces__msg__HeightMap__Sequence__init(go2_interfaces__msg__HeightMap__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  go2_interfaces__msg__HeightMap * data = NULL;

  if (size) {
    data = (go2_interfaces__msg__HeightMap *)allocator.zero_allocate(size, sizeof(go2_interfaces__msg__HeightMap), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = go2_interfaces__msg__HeightMap__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        go2_interfaces__msg__HeightMap__fini(&data[i - 1]);
      }
...
go2_interfaces__msg__HeightMap__Sequence__fini(go2_interfaces__msg__HeightMap__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      go2_interfaces__msg__HeightMap__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  go2_interfaces__msg__HeightMap__Sequence * array = (go2_interfaces__msg__HeightMap__Sequence *)allocator.allocate(sizeof(go2_interfaces__msg__HeightMap__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = go2_interfaces__msg__HeightMap__Sequence__init(array, size);
  if (!success) {
...
go2_interfaces__msg__HeightMap__Sequence__destroy(go2_interfaces__msg__HeightMap__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    go2_interfaces__msg__HeightMap__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
go2_interfaces__msg__HeightMap__Sequence__are_equal(const go2_interfaces__msg__HeightMap__Sequence * lhs, const go2_interfaces__msg__HeightMap__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!go2_interfaces__msg__HeightMap__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  go2_interfaces__msg__HeightMap__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(go2_interfaces__msg__HeightMap);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    go2_interfaces__msg__HeightMap * data =
      (go2_interfaces__msg__HeightMap *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!go2_interfaces__msg__HeightMap__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          go2_interfaces__msg__HeightMap__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!go2_interfaces__msg__HeightMap__copy(
