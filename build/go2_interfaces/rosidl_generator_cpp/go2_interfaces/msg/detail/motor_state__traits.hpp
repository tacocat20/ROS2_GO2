...
#ifndef GO2_INTERFACES__MSG__DETAIL__MOTOR_STATE__TRAITS_HPP_
#define GO2_INTERFACES__MSG__DETAIL__MOTOR_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const go2_interfaces::msg::MotorState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const go2_interfaces::msg::MotorState & msg)
{
  return go2_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<go2_interfaces::msg::MotorState>()
{
  return "go2_interfaces::msg::MotorState";
}

template<>
inline const char * name<go2_interfaces::msg::MotorState>()
{
  return "go2_interfaces/msg/MotorState";
}

template<>
struct has_fixed_size<go2_interfaces::msg::MotorState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<go2_interfaces::msg::MotorState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<go2_interfaces::msg::MotorState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GO2_INTERFACES__MSG__DETAIL__MOTOR_STATE__TRAITS_HPP_
