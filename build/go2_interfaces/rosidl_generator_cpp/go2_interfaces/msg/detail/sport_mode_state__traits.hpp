...
#ifndef GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_STATE__TRAITS_HPP_
#define GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_STATE__TRAITS_HPP_
...
// Member 'stamp'
#include "go2_interfaces/msg/detail/time_spec__traits.hpp"
// Member 'imu_state'
...
inline void to_yaml(
  const go2_interfaces::msg::SportModeState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const go2_interfaces::msg::SportModeState & msg)
{
  return go2_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<go2_interfaces::msg::SportModeState>()
{
  return "go2_interfaces::msg::SportModeState";
}

template<>
inline const char * name<go2_interfaces::msg::SportModeState>()
{
  return "go2_interfaces/msg/SportModeState";
}

template<>
struct has_fixed_size<go2_interfaces::msg::SportModeState>
  : std::integral_constant<bool, has_fixed_size<go2_interfaces::msg::IMU>::value && has_fixed_size<go2_interfaces::msg::TimeSpec>::value> {};

template<>
struct has_bounded_size<go2_interfaces::msg::SportModeState>
  : std::integral_constant<bool, has_bounded_size<go2_interfaces::msg::IMU>::value && has_bounded_size<go2_interfaces::msg::TimeSpec>::value> {};

template<>
struct is_message<go2_interfaces::msg::SportModeState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GO2_INTERFACES__MSG__DETAIL__SPORT_MODE_STATE__TRAITS_HPP_
