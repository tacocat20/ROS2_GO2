...
#ifndef GO2_INTERFACES__MSG__DETAIL__LOW_STATE__TRAITS_HPP_
#define GO2_INTERFACES__MSG__DETAIL__LOW_STATE__TRAITS_HPP_
...
// Member 'imu_state'
#include "go2_interfaces/msg/detail/imu__traits.hpp"
// Member 'motor_state'
#include "go2_interfaces/msg/detail/motor_state__traits.hpp"
// Member 'bms_state'
#include "go2_interfaces/msg/detail/bms_state__traits.hpp"
...
inline void to_yaml(
  const go2_interfaces::msg::LowState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const go2_interfaces::msg::LowState & msg)
{
  return go2_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<go2_interfaces::msg::LowState>()
{
  return "go2_interfaces::msg::LowState";
}

template<>
inline const char * name<go2_interfaces::msg::LowState>()
{
  return "go2_interfaces/msg/LowState";
}

template<>
struct has_fixed_size<go2_interfaces::msg::LowState>
  : std::integral_constant<bool, has_fixed_size<go2_interfaces::msg::BmsState>::value && has_fixed_size<go2_interfaces::msg::IMU>::value && has_fixed_size<go2_interfaces::msg::MotorState>::value> {};

template<>
struct has_bounded_size<go2_interfaces::msg::LowState>
  : std::integral_constant<bool, has_bounded_size<go2_interfaces::msg::BmsState>::value && has_bounded_size<go2_interfaces::msg::IMU>::value && has_bounded_size<go2_interfaces::msg::MotorState>::value> {};

template<>
struct is_message<go2_interfaces::msg::LowState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GO2_INTERFACES__MSG__DETAIL__LOW_STATE__TRAITS_HPP_
