...
#ifndef GO2_INTERFACES__MSG__DETAIL__BMS_STATE__TRAITS_HPP_
#define GO2_INTERFACES__MSG__DETAIL__BMS_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const go2_interfaces::msg::BmsState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const go2_interfaces::msg::BmsState & msg)
{
  return go2_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<go2_interfaces::msg::BmsState>()
{
  return "go2_interfaces::msg::BmsState";
}

template<>
inline const char * name<go2_interfaces::msg::BmsState>()
{
  return "go2_interfaces/msg/BmsState";
}

template<>
struct has_fixed_size<go2_interfaces::msg::BmsState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<go2_interfaces::msg::BmsState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<go2_interfaces::msg::BmsState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GO2_INTERFACES__MSG__DETAIL__BMS_STATE__TRAITS_HPP_
