...
#include "go2_interfaces/msg/detail/sport_mode_state__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_interfaces/msg/detail/imu__functions.h"  // imu_state
#include "go2_interfaces/msg/detail/time_spec__functions.h"  // stamp
...
size_t get_serialized_size_go2_interfaces__msg__TimeSpec(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_go2_interfaces__msg__TimeSpec(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, TimeSpec)();


using _SportModeState__ros_msg_type = go2_interfaces__msg__SportModeState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_interfaces, msg, TimeSpec
      )()->data);
  ...
  // Field name: imu_state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_interfaces, msg, IMU
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_go2_interfaces__msg__SportModeState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SportModeState__ros_msg_type * ros_message = static_cast<const _SportModeState__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_go2_interfaces__msg__TimeSpec(
  ...
  current_alignment += get_serialized_size_go2_interfaces__msg__IMU(
...
static uint32_t _SportModeState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__SportModeState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__SportModeState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: stamp
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_interfaces__msg__TimeSpec(
  ...
  // member: imu_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_interfaces__msg__IMU(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__SportModeState;
    is_plain =
      (
...
static size_t _SportModeState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__SportModeState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, SportModeState)() {
