...
#include "go2_interfaces/msg/detail/sport_mode_cmd__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_interfaces/msg/detail/bms_cmd__functions.h"  // bms_cmd
#include "go2_interfaces/msg/detail/path_point__functions.h"  // path_point

// forward declare type support functions
size_t get_serialized_size_go2_interfaces__msg__BmsCmd(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_go2_interfaces__msg__BmsCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, BmsCmd)();
size_t get_serialized_size_go2_interfaces__msg__PathPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_go2_interfaces__msg__PathPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, PathPoint)();


using _SportModeCmd__ros_msg_type = go2_interfaces__msg__SportModeCmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bms_cmd
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_interfaces, msg, BmsCmd
      )()->data);
  ...
  // Field name: path_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_interfaces, msg, PathPoint
      )()->data);
    size_t size = 30;
...
size_t get_serialized_size_go2_interfaces__msg__SportModeCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SportModeCmd__ros_msg_type * ros_message = static_cast<const _SportModeCmd__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_go2_interfaces__msg__BmsCmd(
  ...
  // field.name path_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_go2_interfaces__msg__PathPoint(
...
static uint32_t _SportModeCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__SportModeCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__SportModeCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: bms_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_interfaces__msg__BmsCmd(
  ...
  // member: path_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_interfaces__msg__PathPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__SportModeCmd;
    is_plain =
      (
...
static size_t _SportModeCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__SportModeCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, SportModeCmd)() {
