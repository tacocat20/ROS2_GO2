...
#include "go2_interfaces/msg/detail/low_cmd__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_interfaces/msg/detail/motor_cmd__functions.h"  // motor_cmd
...
using _LowCmd__ros_msg_type = go2_interfaces__msg__LowCmd;
...
size_t get_serialized_size_go2_interfaces__msg__LowCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowCmd__ros_msg_type * ros_message = static_cast<const _LowCmd__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LowCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__LowCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__LowCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__LowCmd;
    is_plain =
      (
...
static size_t _LowCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__LowCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, LowCmd)() {
