...
#include "go2_interfaces/msg/detail/lidar_state__rosidl_typesupport_fastrtps_c.h"
...
using _LidarState__ros_msg_type = go2_interfaces__msg__LidarState;
...
size_t get_serialized_size_go2_interfaces__msg__LidarState(
  const void * untyped_ros_message,
...
static uint32_t _LidarState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__LidarState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__LidarState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__LidarState;
    is_plain =
      (
...
static size_t _LidarState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__LidarState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, LidarState)() {
