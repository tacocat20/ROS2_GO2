...
#include "go2_interfaces/msg/detail/low_state__rosidl_typesupport_fastrtps_c.h"
...
#include "go2_interfaces/msg/detail/bms_state__functions.h"  // bms_state
#include "go2_interfaces/msg/detail/imu__functions.h"  // imu_state
#include "go2_interfaces/msg/detail/motor_state__functions.h"  // motor_state

// forward declare type support functions
size_t get_serialized_size_go2_interfaces__msg__BmsState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_go2_interfaces__msg__BmsState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, BmsState)();
...
using _LowState__ros_msg_type = go2_interfaces__msg__LowState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bms_state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, go2_interfaces, msg, BmsState
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_go2_interfaces__msg__BmsState(
...
static uint32_t _LowState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__LowState(
  ...
  size_t current_alignment)
{
  ...
  // member: bms_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_go2_interfaces__msg__BmsState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__LowState;
    is_plain =
      (
...
static size_t _LowState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__LowState(
