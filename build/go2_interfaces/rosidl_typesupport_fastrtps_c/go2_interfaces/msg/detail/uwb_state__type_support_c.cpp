...
#include "go2_interfaces/msg/detail/uwb_state__rosidl_typesupport_fastrtps_c.h"
...
using _UwbState__ros_msg_type = go2_interfaces__msg__UwbState;
...
size_t get_serialized_size_go2_interfaces__msg__UwbState(
  const void * untyped_ros_message,
...
static uint32_t _UwbState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_go2_interfaces__msg__UwbState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_go2_interfaces__msg__UwbState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces__msg__UwbState;
    is_plain =
      (
...
static size_t _UwbState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_go2_interfaces__msg__UwbState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, go2_interfaces, msg, UwbState)() {
